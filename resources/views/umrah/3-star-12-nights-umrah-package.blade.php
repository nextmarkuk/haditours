                    ...
                    <div class="package-gallery">
                        <div class="package-slick-carousel">
                            <div><img class="img-fluid" src="{{asset('assets/media/umrah/2%20%2810%29.webp')}}"
                                    alt="3 Star 12 Nights Umrah Package"></div>
                            <div><img class="img-fluid" src="{{asset('assets/media/umrah/3%20%2810%29.webp')}}"
                                    alt="3 Star 12 Nights Umrah Package"></div>
                            <div><img class="img-fluid" src="{{asset('assets/media/umrah/4%20%2810%29.webp')}}"
                                    alt="3 Star 12 Nights Umrah Package"></div>
                            <div><img class="img-fluid" src="{{asset('assets/media/umrah/5%20%289%29.webp')}}"
                                    alt="3 Star 12 Nights Umrah Package"></div>
                        </div>
