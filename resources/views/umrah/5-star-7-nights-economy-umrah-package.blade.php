            ...
            <div class="row">
                <div class="col-md-12 col-lg-12 col-xl-6">
                    <div class="package-gallery">
                        <div class="package-slick-carousel">
                            <div><img class="img-fluid" src="{{asset('assets/media/umrah/03%20%2839%29.webp')}}"
                                    alt="5 star 7 night Umrah package "></div>
                            <div><img class="img-fluid" src="{{asset('assets/media/umrah/02%20%2839%29.webp')}}"
                                    alt="5 star 7 night Umrah package "></div>
                        </div>
                ...
                <div class="col-md-12 col-lg-12 col-xl-6">
                    <div class="package-descrip">
                        <h1 class="heading">5 star 7 night Umrah package </h1>
                            ...
                            <div class="row no-gutters">
                                <div class="col-md-6">
                                    <div class="nights">
                                        <div class="row no-gutters align-items-start">
                                            <div class="col-8">
                                                <p>Makkah Hotel Nights <small>Shohada Hotel Makkah</small></p>
                                            </div>
                                            <div class="col-4">
                                ...
                                <div class="col-md-6">
                                    <div class="nights">
                                        <div class="row no-gutters align-items-start">
                                            <div class="col-8">
                                                <p>Madinah Hotel Nights <small>New Madinah Hotel</small></p>
                                            </div>
                                            <div class="col-4">
                                                <img class="svg" src="weather.svg" alt="weather icon"><strong
                                                    class="days">3</strong>
