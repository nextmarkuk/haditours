            ...
            <div class="row">
                <div class="col-md-12 col-lg-12 col-xl-6">
                    <div class="package-gallery">
                        <div class="package-slick-carousel">
                            <div><img class="img-fluid" src="{{asset('assets/media/umrah/001.webp')}}"
                                    alt="10 Nights 5 Star March Umrah package"></div>
                            <div><img class="img-fluid" src="{{asset('assets/media/umrah/02%20%288%29.webp')}}"
                                    alt="10 Nights 5 Star March Umrah package"></div>
                            <div><img class="img-fluid" src="{{asset('assets/media/umrah/03%20%288%29.webp')}}"
                                    alt="10 Nights 5 Star March Umrah package"></div>
                            <div><img class="img-fluid" src="{{asset('assets/media/umrah/04%20%288%29.webp')}}"
                                    alt="10 Nights 5 Star March Umrah package"></div>
                            <div><img class="img-fluid" src="{{asset('assets/media/umrah/05%20%284%29.webp')}}"
                                    alt="10 Nights 5 Star March Umrah package"></div>
                            <div><img class="img-fluid" src="{{asset('assets/media/umrah/06.webp')}}"
                                    alt="10 Nights 5 Star March Umrah package"></div>
                        </div>
                ...
                <div class="col-md-12 col-lg-12 col-xl-6">
                    <div class="package-descrip">
                        <h1 class="heading">10 Nights 5 Star March Umrah package</h1>
                                ...
                                <div class="col-md-6">
                                    <div class="nights">
                                        <div class="row no-gutters align-items-start">
                                            <div class="col-8">
                                                <p>Makkah Hotel Nights <small>Makkah Clock Royal Tower</small></p>
                                            </div>
                                            <div class="col-4">
                        ...
                        <div class="pkg-facilities">
                            ...
                            <div class="facility">
                                <div class="facility-img">
                                    <img src="breakfast.svg" alt="Breakfast" class="svg">
                                </div>
                                <span>Breakfast</span>
                            </div>
                        </div>
