...
@section('content')
            ...
            <div class="row">
                <div class="col-md-12 col-lg-12 col-xl-6">
                    <div class="package-gallery">
                        <div class="package-slick-carousel">
                            <div><img class="img-fluid" src="{{asset('assets/media/umrah/1%20%284%29.webp')}}"
                                    alt="4 Star 10 Nights December Umrah Package"></div>
                            <div><img class="img-fluid" src="{{asset('assets/media/umrah/2%20%284%29.webp')}}"
                                    alt="4 Star 10 Nights December Umrah Package"></div>
                            <div><img class="img-fluid" src="{{asset('assets/media/umrah/3%20%284%29.webp')}}"
                                    alt="4 Star 10 Nights December Umrah Package"></div>
                            <div><img class="img-fluid" src="{{asset('assets/media/umrah/4%20%284%29.webp')}}"
                                    alt="4 Star 10 Nights December Umrah Package"></div>
                            <div><img class="img-fluid" src="{{asset('assets/media/umrah/5%20%284%29.webp')}}"
                                    alt="4 Star 10 Nights December Umrah Package"></div>
                        </div>
                ...
                <div class="col-md-12 col-lg-12 col-xl-6">
                    <div class="package-descrip">
                        <h1 class="heading">4 Star 10 Nights December Umrah Package</h1>
                        ...
                        <div class="price">
                            <p>Price <span>&pound; 1050</span></p>
                        </div>
    ...
    <section class="package-content">
        <div class="container">
            <h3>DETAILS</h3>
            <p>The 4 Star 10 Nights December Umrah Package&nbsp;is now available at &pound;740 with QUAD sharing rooms.
                Your stay will be 5 nights in 4-star Dar Al Eiman Grand Hotel in Makkah. Similarly, 5 nights in Madinah
