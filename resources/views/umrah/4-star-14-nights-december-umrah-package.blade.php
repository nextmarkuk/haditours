...
@section('content')
            ...
            <div class="row">
                <div class="col-md-12 col-lg-12 col-xl-6">
                    <div class="package-gallery">
                        <div class="package-slick-carousel">
                            <div><img class="img-fluid" src="{{asset('assets/media/umrah/01-min%20%2838%29.webp')}}"
                                    alt="4 Star 14 Nights December Umrah Package"></div>
                            <div><img class="img-fluid" src="{{asset('assets/media/umrah/02-min%20%2835%29.webp')}}"
                                    alt="4 Star 14 Nights December Umrah Package"></div>
                            <div><img class="img-fluid" src="{{asset('assets/media/umrah/03-min%20%2835%29.webp')}}"
                                    alt="4 Star 14 Nights December Umrah Package"></div>
                            <div><img class="img-fluid" src="{{asset('assets/media/umrah/04-min%20%2835%29.webp')}}"
                                    alt="4 Star 14 Nights December Umrah Package"></div>
                            <div><img class="img-fluid" src="{{asset('assets/media/umrah/05-min%20%2818%29.webp')}}"
                                    alt="4 Star 14 Nights December Umrah Package"></div>
                        </div>
                ...
                <div class="col-md-12 col-lg-12 col-xl-6">
                    <div class="package-descrip">
                        <h1 class="heading">4 Star 14 Nights December Umrah Package</h1>
                        ...
                        <div class="price">
                            <p>Price <span>&pound; 1130</span></p>
                        </div>
    ...
    <section class="package-content">
        <div class="container">
            <h3>DETAILS</h3>
            <p>The 4 Star 14 Nights December Umrah Package 2025&nbsp;is now available at &pound;840 with QUAD sharing
                rooms. Your stay will be 7 nights in 4-star Dar Al Eiman Grand Hotel in Makkah. Similarly, 7 nights in
                Madinah in 4-star Saja Al Madinah Hotel. The services like transport, Ziyarah, Breakfast, aren&rsquo;t
