        ...
        <div class="container">
            ...
            <div class="pkg-price-bar">
                <div class="price-text text-white">
                    FROM <span class="text-white">&pound; 1130</span> per person
                </div>
            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="section-card">
                        ...
                        <p class="description text-justify">Embark on a comprehensive 14-night spiritual journey this December with Hadi Tours. Experience the luxury and comfort of VOCO Makkah and Saja Al Medina, both offering exceptional service and convenient access to the holy mosques. This extended package allows for a deeply immersive and peaceful pilgrimage during the beautiful winter season.</p>
                    </div>
