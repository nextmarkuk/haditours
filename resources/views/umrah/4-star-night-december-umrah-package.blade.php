                ...
                <div class="col-md-12 col-lg-12 col-xl-6">
                    <div class="package-gallery">
                        <div class="package-slick-carousel">
                            <div><img class="img-fluid" src="{{asset('assets/media/umrah/1%20%286%29.webp')}}"
                                    alt="4 Star 14 Nights December Umrah Package"></div>
                            <div><img class="img-fluid" src="{{asset('assets/media/umrah/2%20%286%29.webp')}}"
                                    alt="4 Star 14 Nights December Umrah Package"></div>
                            <div><img class="img-fluid" src="{{asset('assets/media/umrah/3%20%286%29.webp')}}"
                                    alt="4 Star 14 Nights December Umrah Package"></div>
                            <div><img class="img-fluid" src="{{asset('assets/media/umrah/4%20%286%29.webp')}}"
                                    alt="4 Star 14 Nights December Umrah Package"></div>
                            <div><img class="img-fluid" src="{{asset('assets/media/umrah/5%20%285%29.webp')}}"
                                    alt="4 Star 14 Nights December Umrah Package"></div>
                        </div>
                            ...
                            <div class="row no-gutters">
                                <div class="col-md-6">
                                    <div class="nights">
                                        <div class="row no-gutters align-items-start">
                                            <div class="col-8">
                                                <p>Makkah Hotel Nights <small>Elaf Ajyad</small></p>
                                            </div>
                                            <div class="col-4">
                                ...
                                <div class="col-md-6">
                                    <div class="nights">
                                        <div class="row no-gutters align-items-start">
                                            <div class="col-8">
                                                <p>Madinah Hotel Nights <small>Elaf Taibah </small></p>
                                            </div>
                                            <div class="col-4">
                                                <img class="svg" src="weather.svg" alt="weather icon"><strong
                                                    class="days">7</strong>
