...
@section('content')
            ...
            <div class="row">
                <div class="col-md-12 col-lg-12 col-xl-6">
                    <div class="package-gallery">
                        <div class="package-slick-carousel">
                            <div><img class="img-fluid" src="{{asset('assets/media/umrah/01-min%20%289%29.webp')}}"
                                    alt="4 Star 7 Nights December Umrah Package"></div>
                            <div><img class="img-fluid" src="{{asset('assets/media/umrah/02-min%20%289%29.webp')}}"
                                    alt="4 Star 7 Nights December Umrah Package"></div>
                            <div><img class="img-fluid" src="{{asset('assets/media/umrah/03-min%20%289%29.webp')}}"
                                    alt="4 Star 7 Nights December Umrah Package"></div>
                            <div><img class="img-fluid" src="{{asset('assets/media/umrah/04-min%20%289%29.webp')}}"
                                    alt="4 Star 7 Nights December Umrah Package"></div>
                            <div><img class="img-fluid" src="{{asset('assets/media/umrah/05-min%20%281%29.webp')}}"
                                    alt="4 Star 7 Nights December Umrah Package"></div>
                        </div>
                ...
                <div class="col-md-12 col-lg-12 col-xl-6">
                    <div class="package-descrip">
                        <h1 class="heading">4 Star 7 Nights December Umrah Package</h1>
                        ...
                        <div class="price">
                            <p>Price <span>&pound; 1015</span></p>
                        </div>
    ...
    <section class="package-content">
        <div class="container">
            <h3>DETAILS</h3>
            <p>The 4 Star 7 Nights December Umrah Package&nbsp;is now available at &pound;710 with QUAD sharing rooms.
                Your stay will be 4 nights in 4-star Dar Al Eiman Grand Hotel in Makkah. Similarly, 3 nights in Madinah
                in 4-star Saja Al Madinah Hotel. The services like transport, Ziyarah, Breakfast, aren&rsquo;t included
                in this package.</p>
        </div>
    </section>
