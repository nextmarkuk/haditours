                ...
                <div class="col-md-12 col-lg-12 col-xl-6">
                    <div class="package-gallery">
                        <div class="package-slick-carousel">
                            <div><img class="img-fluid" src="{{asset('assets/media/umrah/01-min%20%2841%29.webp')}}"
                                    alt="4 Star 10 Nights December Umrah Package"></div>
                            <div><img class="img-fluid" src="{{asset('assets/media/umrah/02-min%20%2838%29.webp')}}"
                                    alt="4 Star 10 Nights December Umrah Package"></div>
                            <div><img class="img-fluid" src="{{asset('assets/media/umrah/03-min%20%2838%29.webp')}}"
                                    alt="4 Star 10 Nights December Umrah Package"></div>
                            <div><img class="img-fluid" src="{{asset('assets/media/umrah/04-min%20%2836%29.webp')}}"
                                    alt="4 Star 10 Nights December Umrah Package"></div>
                        </div>
                            ...
                            <div class="row no-gutters">
                                ...
                                <div class="col-md-6">
                                    <div class="nights">
                                        <div class="row no-gutters align-items-start">
                                            <div class="col-8">
                                                <p>Madinah Hotel Nights <small>Elaf Meshal Al Madina</small></p>
                                            </div>
                                            <div class="col-4">
                                                <img class="svg" src="weather.svg" alt="weather icon"><strong
                                                    class="days">5</strong>
