            ...
            <div class="row">
                <div class="col-md-12 col-lg-12 col-xl-6">
                    <div class="package-gallery">
                        <div class="package-slick-carousel">
                            <div><img class="img-fluid" src="{{asset('assets/media/umrah/02%20%2811%29.webp')}}"
                                    alt="12 Nights 5 Star March Umrah Package"></div>
                            <div><img class="img-fluid" src="{{asset('assets/media/umrah/03%20%2811%29.webp')}}"
                                    alt="12 Nights 5 Star March Umrah Package"></div>
                            <div><img class="img-fluid" src="{{asset('assets/media/umrah/04%20%2811%29.webp')}}"
                                    alt="12 Nights 5 Star March Umrah Package"></div>
                        </div>
                ...
                <div class="col-md-12 col-lg-12 col-xl-6">
                    <div class="package-descrip">
                        <h1 class="heading">12 Nights 5 Star March Umrah Package</h1>
                                ...
                                <div class="col-md-6">
                                    <div class="nights">
                                        <div class="row no-gutters align-items-start">
                                            <div class="col-8">
                                                <p>Makkah Hotel Nights <small>Jabal Omar Marriott Hotel</small></p>
                                            </div>
                                            <div class="col-4">
